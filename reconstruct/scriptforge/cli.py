...
from . import report as reporting, timeline, validate, webapp
...
def build_parser() -> argparse.ArgumentParser:
    ...
    run.add_argument("--reasoning-effort", default=None, choices=[None, "low", "medium", "high"])
    ...
    forge.add_argument("--reasoning-effort", default="high", choices=["low", "medium", "high"])
